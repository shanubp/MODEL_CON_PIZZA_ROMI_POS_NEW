...
class history_print extends StatefulWidget {
  ...
  const history_print(
      {Key? key,
        ...
        required this.delivery, required this.items,
        required this.tableName, required this.cashPaid, required this.bankPaid, required this.balance,
      })
      : super(key: key);
...
class _history_printState extends State<history_print> {
  ...
  initSavetoPath() async {
    ...
    const filename = 'assets/AlzeeBillLogo.png';
    const filename1 = 'print.png';
    var bytes = await rootBundle.load("assets/AlzeeBillLogo.png");
