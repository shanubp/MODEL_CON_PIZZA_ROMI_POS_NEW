...
generatePdfReturn(BillModelReturn model) async {
                          ...
                          children: [
                            TableHelper.fromTextArray(
                                ...
                                data: List.generate(map!.productItems.length,
                                      ...
                                      var addOnPrice = data['addOnPrice'] ??
                                          0 - data['removePrice'] ??
                                          0 - data['addLessPrice'] ??
                                          0 + data['addMorePrice'] ??
                                          0;
...
//content
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          (discount == null
                              ? "0.00"
                              : map!.discount.toStringAsFixed(2)),
                          style: const TextStyle(
                            color: PdfColors.black,
                            fontSize: 10,
                            // fontWeight: FontWeight.w600
                  ...
                  Container(
                      ...
                      child: Center(
                          child: Text(
                            'RETURN ITEMS',
                            style: TextStyle(color: PdfColors.black, fontSize: 10),
                          ))),
                  Container(
                      decoration: const BoxDecoration(
                        color: PdfColors.white,
                        ...
                        Row(
                          ...
                          children: [
                            TableHelper.fromTextArray(
                                ...
                                data: List.generate(map!.returnItems.length,
                                        (index) {
                                      final data = map!.returnItems[index];
                                      var addOnPrice = data['addOnPrice'] ??
                                          0 - data['removePrice'] ??
                                          0 - data['addLessPrice'] ??
                                          0 + data['addMorePrice'] ??
                  ...
                  Container(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text('Total Return Amount - الإجمالي     :  ',
                            style: TextStyle(
                              font: myFont2,
                              color: PdfColors.black,
                              fontSize: 12,
