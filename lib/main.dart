...
// import 'package:awafi_pos/DailyReport/generate_pdf.dart';
// import 'package:awafi_pos/billModel.dart';
import 'package:awafi_pos/firebase_options.dart';
import 'package:awafi_pos/pdf/generatePdf.dart';
...
getWaiters() async {
  await FirebaseFirestore.instance
    ...
    for (var names in value.docs) {
      waitersName.add(names.get("name"));
    }
  });
}
...
// List<im.Image> imageListWindows = [];
// setPrinterImagesWindows() async {
//   // while (printWidth == 0) {
//   //   await Future.delayed(Duration(seconds: 1));
//   // }
//   capturedImage1 = await screenshotController.captureFromWidget(Container(
                              ...
                              InkWell(
                                onLongPress: () async {
                                  QuerySnapshot doc = await FirebaseFirestore
                                      ...
                                      .collection('tables')
                                      .where('name',
                                      isEqualTo: tables[index].toString())
                                                  ...
                                                  builder:
                                                    ...
                                                    if (snapshot.data!
                                                      ...
                                                      in snapshot.data!
                                                        ...
                                                        totalAmount += (double.tryParse(item[
                                                        'price']
                                                            .toString())! +
                                                            double.tryParse(
                                                                (item['addOnPrice'] ??
                                                              ...
                                                              children: [
                                                                ...
                                                                Column(
                                                                  ...
                                                                  children: [
                                                                    Text(
                                                                      arabicLanguage
                                                                          ? "SR ${arabicNumber.convert((totalAmount * 100 / (100 + gst)).toStringAsFixed(2))}"
                                                                    ...
                                                                    Text(
                                                                      arabicLanguage
                                                                          ? (double.tryParse(discount) == null ? arabicNumber.convert(00) : "SR ${arabicNumber.convert(double.tryParse(discount)!.toStringAsFixed(2))}")
                                                                          : (double.tryParse(discount) == null ? "0.00" : "SR ${double.tryParse(discount)!.toStringAsFixed(2)}"),
                                                                      style: TextStyle(
                                                                          fontWeight: FontWeight.bold,
                                                                          fontSize: 15,
                                                                          color: Colors.grey.shade700),
                                                                    ...
                                                                    Text(
                                                                      arabicLanguage
                                                                          ? " SR ${arabicNumber.convert((totalAmount * gst / (100 + gst)).toStringAsFixed(2))}"
                                                                    ...
                                                                    Text(
                                                                      arabicLanguage
                                                                          ? (double.tryParse(delivery) == null ? arabicNumber.convert(00) : "SR ${arabicNumber.convert(double.tryParse(delivery)!.toStringAsFixed(2))}")
                                                                          : (double.tryParse(delivery) == null ? "0.00" : "SR ${double.tryParse(delivery)!.toStringAsFixed(2)}"),
                                                                      style: TextStyle(
                                                                          fontWeight: FontWeight.bold,
                                                                          fontSize: 15,
                                                                          color: Colors.grey.shade700),
                                                                    ...
                                                                    Text(
                                                                      arabicLanguage
                                                                          ? "SR ${arabicNumber.convert((totalAmount - (double.tryParse(discount) ?? 0) + (double.tryParse(delivery) ?? 0)).toStringAsFixed(2))}"
                                                                                ...
                                                                                TextButton(
                                                                                  ...
                                                                                  onPressed: () async {
                                                                                    ...
                                                                                    if (!disable) {
                                                                                      ...
                                                                                      try {
                                                                                        if (items.isNotEmpty) {
                                                                                          DocumentSnapshot invoiceNoDoc = await FirebaseFirestore.instance.collection('invoiceNo').doc(currentBranchId).get();
                                                                                          ...
                                                                                          blue
                                                                                            ...
                                                                                            double.tryParse(paidBank.text) ?? 0,
                                                                                            balance ?? 0,
                                                                                            netTotal ?? 0,
                                                                                            dropdownvalue!,
                                                                                          );
                                                                                          await FirebaseFirestore.instance.collection('sales').doc(currentBranchId).collection('sales').doc(invoiceNo.toString()).set({
                                                                                            ...
                                                                                            'cash': approve
                                                                                                ? false
                                                                                                : paidCash.text == '' || paidCash.text == '0.0' || double.tryParse(paidCash.text)! <= 0 || paidCash.text == null
                                                                                                ? false
                                                                                                : true,
                                                                                          ...
                                                                                          FirebaseFirestore.instance.collection('invoiceNo').doc(currentBranchId).update({
                                                                                            'sales': FieldValue.increment(1),
                                                                                            'token': FieldValue.increment(1)
                                                                                          });

                                                                                          await FirebaseFirestore.instance.collection('tables').doc(currentBranchId).collection('tables').doc(selectedTable).update({
                                                                                            'items': []
                                                                                          });
                                                                                          setState(() {
                                                                                            mobileNo.text = '';
                                              ...
                                              children: [
                                                ...
                                                Container(
                                                  ...
                                                  child: Center(
                                                      child: Text(
                                                        arabicLanguage
                                                            ? '  المتبقي:${arabicNumber.convert(balance.toString())}'
                                            ...
                                            if (paidCash.text != '' ||
                                              ...
                                              for (var b in items) {
                                                if (b["variantName"] !=
                                                    '') {
                                                  b['pdtname'] =
                                                  "${b["pdtname"]} ${b["variantName"] ?? ''}";
                                                  b['arabicName'] =
                                                  "${b["arabicName"]} ${b["variantNameArabic"] ?? ''}";
                                                }
                                              }
                                              // if(currentWaiter!=null){
                                              if (!disable) {
