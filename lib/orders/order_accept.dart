...
class AcceptedOrdersWidget extends StatefulWidget {
  ...
  const AcceptedOrdersWidget({Key? key, required this.orderId}) : super(key: key);
        ...
        Container(
          ...
          child:     Row(
            ...
            children: [
              ...
              Text(grantTotal.toStringAsFixed(2) ,style:  TextStyle(color: Colors.black,fontSize: fontSize+7,fontWeight: FontWeight.w700),),
            ],
          ),
        ),
        Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          FFButtonWidget(
                            ...
                            loading: _loadingButton, icon: Icon(Icons.book), iconData: Icons.book,
                          ),
                          FFButtonWidget(
                            onPressed: () async {
                              setState(() => _loadingButton = true);
                            ...
                            loading: _loadingButton, icon: Icon(Icons.arrow_circle_right_outlined), iconData: Icons.arrow_circle_right_outlined,
                          ),
                        ],
                      ),
                    ),
