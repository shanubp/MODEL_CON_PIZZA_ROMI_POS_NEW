        ...
        child: Container(
          ...
          decoration: const BoxDecoration(
            image: DecorationImage(
              image: AssetImage("assets/pizzaromiBackground.png"),fit: BoxFit.cover
            )
          ),
          child: Row(
            children: [
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Container(
                                            ...
                                            decoration: const BoxDecoration(
                                              image: DecorationImage(
                                                image: AssetImage("assets/pizzaromi512.png")
                                              )
                                            ),
                                          ),
                                        ),
                                        ...
                                        const Text('version :0.1.8',style: TextStyle(fontSize: 12,color: Colors.grey),),
                                      ],
                                    ),
                                  ),
                                ),
