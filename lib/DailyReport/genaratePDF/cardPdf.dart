...
class CardPdfPage {
  ...
  static Future<File> generate(CardReportData invoice) async {
    double gdtotal=0;
...
//STUDENT DETAIL
          ...
          pw.Container(
            child:  pw.Table.fromTextArray(
                ...
                data:
                List.generate(invoice.card.length, (index) {
                  final item =invoice.card[index];
                  double? total=double.tryParse(item["TOTAL"].toString());
                  gdtotal+=total!;
