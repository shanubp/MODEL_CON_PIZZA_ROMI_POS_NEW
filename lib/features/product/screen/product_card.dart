            ...
            if (item['pdtname'] == widget.name &&
                item['price'] ==
                    (((offCategoryLowercase
                            ...
                            offer)
                        ? widget.discountPrice! * (1 - (offerValue! / 100))
              ...
              'items': FieldValue.arrayUnion([
                {
                  ...
                  'price': ((offCategoryLowercase
                              .contains(widget.category!.toLowerCase())) &&
                          offer)
                      ? widget.discountPrice! * (1 - (offerValue! / 100))
                      : widget.discountPrice,
                  'discount': ((offCategoryLowercase
                              .contains(widget.category!.toLowerCase())) &&
                          offer)
                      ? widget.discountPrice! * (offerValue! / 100)
                      : 0,
                  'qty': 1,
                  'addOns': [],
                  'addLess': [],
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
                  ...
                  child: ClipRRect(
                    ...
                    child: display_image
                        ? CachedNetworkImage(
                            ...
                            memCacheWidth:
                                300, // Set a custom width for memory cache
                            memCacheHeight:
                                300, // Set a custom height for memory cache
              ...
              Text(
                  arabicLanguage
                      ? arabicNumber.convert(widget.discountPrice.toString())
...
class _BoxState extends State<Box> {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: AlertDialog(
        title: Text(
          arabicLanguage ? "اختر البديل" : "Choose Variant",
                ...
                child: InkWell(
                  onTap: () async {
                    setState(() {
                      ...
                      selectedvariantPrice = (((offCategoryLowercase
                                  .contains(widget.category!.toLowerCase())) &&
                              offer)
                          ? double.tryParse(
                                  widget.varList![index]['price'].toString())! *
                              (1 - (offerValue! / 100))
                          : double.tryParse(
                              widget.varList![index]['price'].toString()))!;
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          arabicLanguage
                              ? "${arabicNumber.convert(widget.varList![index]['price'])}"
        ...
        actions: <Widget>[
          TextButton(
            ...
            child: Container(
              ...
              child: Text(arabicLanguage ? "يلغي" : "Cancel",
    ...
    &&item['addMore'].isEmpty
    &&item['addLess'].isEmpty
    &&item['remove'].isEmpty
    ){
    ...
    Navigator.of(context).pop();
            ...
            child: Container(
              padding: const EdgeInsets.all(14),
              child: Text(arabicLanguage ? "منتهي" : "Done",
