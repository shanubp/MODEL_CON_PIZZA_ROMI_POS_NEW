        ...
        build: (context) => [
          ...
          pw.Container(
            ...
            child:pw.Row(
                ...
                children: [
                  pw.Image(image,width: 110,height: 100,fit: pw.BoxFit.contain),
                ]
            ),
          ),
          pw.Text('Credit Report',
              style: pw.TextStyle(
          ...
          pw.Container(
            child:  pw.Table.fromTextArray(
                ...
                data:
                List.generate(invoice.creditSaleData.length, (index) {
                  final item =invoice.creditSaleData[index];
                  // double total=double.tryParse(item["price"].toString());
                  gdtotal+=item["grandTotal"];
...
//       ],
    ...
    //android
    return PdfApi.saveDocument(name: 'Credit  Report.pdf', pdf: pdf);
